export const CONTROLLERS=[{id:"PXC4-2",label:"PXC4-2",maxIOPoints:80,maxTxmModules:{polling:64,event:8},internalTxmSupply_mA:300,txsSupplyPerUnit_mA:1200,txsMaxUnits:1,commCaps:{knx:{maxDevices:64},modbus:{maxTcpNetworks:3},mbus:{ports:1,simpleLoadsPerPort:4,maxDevicesWithRepeater:250}},dims:{w_mm:198,h_mm:124,d_mm:70}},{id:"PXC5.E24",label:"PXC5.E24",maxIOPoints:100,maxTxmModules:{polling:64,event:8},internalTxmSupply_mA:300,txsSupplyPerUnit_mA:1200,commCaps:{knx:{maxDevices:64},modbus:{maxTcpNetworks:10},mbus:{ports:1,simpleLoadsPerPort:4,maxDevicesWithRepeater:250}},dims:{w_mm:270,h_mm:124,d_mm:70}},{id:"PXC7.E400",label:"PXC7.E400",maxIOPoints:400,maxTxmModules:{polling:64,event:8},internalTxmSupply_mA:300,txsSupplyPerUnit_mA:1200,txsMaxUnits:4,commCaps:{knx:{maxDevices:64},modbus:{maxTcpNetworks:10},mbus:{ports:1,simpleLoadsPerPort:4,maxDevicesWithRepeater:250}},dims:{w_mm:198,h_mm:124,d_mm:70}}];
